...
//            tenants.put(tenantId, companyName);
//
//            // Initialize tenant-specific tables and data
//            initializeTenantTables(tenantId);
//
//            logger.info("Tenant {} created successfully", tenantId);
//        } catch (DataAccessException e) {
...
//    // "created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, " +
//    // "updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, " +
//    // "CONSTRAINT fk_project FOREIGN KEY(project_id) REFERENCES " + tenantId +
//    // ".projects(id)" +
//    // ")");
//    //
//    // // Create comments table
...
//    // "content TEXT NOT NULL, " +
//    // "created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, " +
//    // "CONSTRAINT fk_task FOREIGN KEY(task_id) REFERENCES " + tenantId +
//    // ".tasks(id)" +
//    // ")");
//    //
