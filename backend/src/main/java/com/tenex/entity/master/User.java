...
public class User {
    ...
    public User(String adminUsername, String adminEmail, String password) {
        this.username = adminUsername;
        this.email = adminEmail;
        this.password = password;
    }

    public User(String adminUsername, String adminEmail, String encode,Boolean isSuperAdmin) {
        this.username = adminUsername;
        this.email = adminEmail;
